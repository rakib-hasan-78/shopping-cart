...
const ProductDetails = () => {
  ...
  return (
    <div className='w-full h-auto'>
      <div className="border border-project-white bg-project-white xxs:w-11/12 lg:w-8/12 h-auto lg:h-[480px] absolute  left-1/2 top-2/8 lg:top-5/8 transform -translate-x-1/2 lg:-translate-y-4/8 rounded-2xl p-3.5  z-0">
          ...
          <div className='w-full lg:w-5/12 h-full lg:h-72 flex flex-col items-start justify-start'>
            ...
            <div className="w-full h-auto my-1">
              {availability ? (
                ...
                <button className='btn btn-xs rounded-2xl text-xs font-extralight border-red-500 bg-red-500/10 text-red-500 shadow-none'>
                  out of stock
                </button>
              )}
            </div>
            ...
            <div className='flex flex-col text-[8px] lg:text-[10px] leading-5'>
              {specification?.map((spec, i) => (
                <span className='flex flex-row items-center justify-start space-x-5' key={i}>
                 <span className='mr-2'> 
            ...
            <div className="w-full h-auto my-1">
              ...
              <span className='flex items-center space-x-3 mt-1'>
                <Rating rating={rating} size='w-6 h-6' />
